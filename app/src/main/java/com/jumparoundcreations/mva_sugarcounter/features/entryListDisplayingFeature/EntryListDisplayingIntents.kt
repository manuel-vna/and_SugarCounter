...
sealed class EntryListDisplayingIntents {
    ...
    data class LoadEntryDataIntoCardDetails(val sugarEntry: SugarEntry) :
    ...
    data class ShowDeleteEntryConfirmation(val isShown: Boolean) : EntryListDisplayingIntents()
    data class DeleteEntry(val entryId: Int) : EntryListDisplayingIntents()
    ...
    data class ChangeSearchTextFieldText(val newText: String) : EntryListDisplayingIntents()
