...
class SaveCategoryInDatabaseUseCaseTest {
    ...
    @Test
    fun `invoke calls insertCategory when category is new`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke calls updateCategory when category exists and barcode is provided`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke does nothing when category exists and barcode is empty`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `invoke trims whitespace from category and barcode`() =
        runTest {
            // Arrange
